...
@Component({
  selector: 'app-seamen',
  templateUrl: './seamen.component.html',
  styleUrls: ['./seamen.component.css']
})
export class SeamenComponent implements OnInit {
  users:any = []
  ...
  GetInfo(){
    this.service.GetSeamens().subscribe((res)=>{
      console.log(res);
      this.users = res;
